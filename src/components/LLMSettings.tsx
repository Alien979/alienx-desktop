...
export default function LLMSettings({
  ...
  const handleValidate = async () => {
    ...
    if (meta && !meta.requiresApiKey) {
      ...
      try {
        ...
        if (isValid) {
          ...
          setValidationMessage(
            "Service is not available. Please ensure the service is running.",
          );
        }
      } catch (error) {
        setValidationStatus("error");
    ...
    if (selectedProvider === "anthropic" && !trimmedKey.startsWith("sk-ant-")) {
      setValidationStatus("invalid");
      setValidationMessage(
        'Invalid API key format. Anthropic keys must start with "sk-ant-"',
      );
      return;
    }
  ...
  const handleRemove = () => {
    if (
      confirm("Are you sure you want to remove the API key for this provider?")
    ) {
        ...
        <div className="llm-settings-content">
          ...
          {(() => {
                ...
                <div className="settings-section">
                  ...
                  {meta?.requiresEndpoint && (
                    <div style={{ marginTop: "1rem" }}>
                      ...
                      />
                      <p className="help-text">
                        Your local Ollama server endpoint (default:
                      ...
                      >
                        <strong>Accessing remotely?</strong> If you're accessing
                        ALIENX from another device or getting CORS errors,
                        you'll need to configure Ollama to allow remote
                        connections.{" "}
                        <a
            ...
            return (
              <div className="settings-section">
                ...
                />
                <p className="help-text">
                  Your API key is stored locally in your browser. It never
                ...
                {meta.requiresEndpoint && (
                  ...
                  >
                    ...
                    <input
                      ...
                      className="api-key-input"
                    />
                    <p className="help-text">Your Azure OpenAI endpoint URL</p>
                  </div>
                )}
              </div>
            );
          ...
          <div className="settings-info">
            ...
            <p className="warning-text">
              ⚠️ API usage may incur costs. Check your provider's pricing before
              use.
            </p>
          </div>
        </div>
